...
func (self *Log) printf(format string, values ...any) {
	self.logger.Debug().Str("function", getCallerFunctionName()).Msgf(format, values...)
}
...
func (self *Log) trace(format string, values ...any) {
	self.logger.Trace().Str("function", getCallerFunctionName()).Msgf(format, values...)
}
...
func (self *Log) info(format string, values ...any) {
	self.logger.Info().Str("function", getCallerFunctionName()).Msgf(format, values...)
}

// nolint:goprintffuncname // reason: keep in line with logger function naming
func (self *Log) warn(format string, values ...any) {
	self.logger.Warn().Str("function", getCallerFunctionName()).Msgf(format, values...)
}

// nolint:goprintffuncname // reason: keep in line with logger function naming
func (self *Log) error(format string, values ...any) {
	self.logger.Error().Str("function", getCallerFunctionName()).Msgf(format, values...)
}

// nolint:goprintffuncname // reason: keep in line with logger function naming
func (self *Log) fatal(format string, values ...any) {
	self.logger.Fatal().Str("function", getCallerFunctionName()).Msgf(format, values...)
}

// nolint:goprintffuncname // reason: keep in line with logger function naming
func (self *Log) panic(format string, values ...any) {
	self.logger.Panic().Str("function", getCallerFunctionName()).Msgf(format, values...)
}
